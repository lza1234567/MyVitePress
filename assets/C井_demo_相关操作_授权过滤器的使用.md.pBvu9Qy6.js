import{_ as i,o as a,c as n,a6 as l}from"./chunks/framework.C1lYeS_4.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"C井/demo/相关操作/授权过滤器的使用.md","filePath":"C井/demo/相关操作/授权过滤器的使用.md"}'),p={name:"C井/demo/相关操作/授权过滤器的使用.md"};function t(h,s,k,e,E,r){return a(),n("div",null,[...s[0]||(s[0]=[l(`<nav class="table-of-contents"><ul></ul></nav><div class="language-C"><button title="Copy Code" class="copy"></button><span class="lang">C</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">using Microsoft.AspNetCore.Mvc;</span></span>
...
<span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">        }</span></span></code></pre></div>`,3)])])}const y=i(p,[["render",t]]);export{g as __pageData,y as default};
